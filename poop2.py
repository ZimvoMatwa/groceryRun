...
# def woolworths():
# for page in pages:
wURL = "https://www.woolworths.co.za/cat/Food/Food-To-Go/_/N-11buko0"
...
# sleep(randint(2, 10)) # if you are going through many pages on a site, uncomment this line so the code pauses for every request to prevent being blocked by the site
...
for cont in details:
    for buns in groceryList:
        if buns.lower() in cont.find("a", class_="range--title").get_text().strip().lower():
        ...
        # else:
        #     print("skipping line")for t in fonzer:
